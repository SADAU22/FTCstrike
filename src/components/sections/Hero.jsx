...
import HeroGraphic from '../../assets/graphics/5411594489169645015 (1).webp'
...
function Hero() {
  ...
  return (
    ...
    <div > 
        <h1 className="text-primary-50 mb-6 text-6xl/18 font-semibold tracking-tighter max-xl:mb-4 max-xl:text-5xl/16 max-lg:text-4xl/10 max-lg:tracking-tight ">Знакомьтесь команда Strike </h1>
        <p className="text-primary-100 mb-10 text-xl/loose font-light max-xl:mb-8 max-xl:text-lg/8 max-lg:text-base/loose"> Давайте познакомимя с нашей командой  <br/>
        и миром робототехники</p>
